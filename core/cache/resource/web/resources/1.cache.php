<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Главная',
    'longtitle' => 'Последние новости и акции из мира туризма',
    'description' => '',
    'alias' => 'index',
    'link_attributes' => '',
    'published' => 1,
        ...
        <div class="top-header">
          <div class="top-header__wrap">
            ...
            <nav class="main-navigation">
              <ul class="nav-list"><li class="nav-list__nav-item" class="first active">
...
<li class="tags-list__item"><a href="show-posts.html?tag=shopping" class="tags-list__item__link">шоппинг</a></li></ul>
	...
	<footer class="main-footer">
        <div class="content-footer">
          <div class="bottom-menu">
            <ul class="b-menu__list"><li class="b-menu__list__item" class="first active">
  ...
  'elementCache' => 
  array (
    '[[$includes]]' => '<title>Главная - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
