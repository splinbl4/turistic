<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Вывод статей по тегу',
    'longtitle' => '',
    'description' => '',
    'alias' => 'show-posts',
    'link_attributes' => '',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1481977981,
    'editedby' => 1,
    'editedon' => 1481982792,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1481977980,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="ru">
  <head>
    <title>Вывод статей по тегу - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
              ...
              [[!pdoPage?
				...
				&leftJoin=`{
					...
					"Tv": {
						...
						"on": "TaggerTagResource.resource = Tv.contentid AND Tv.tmplvarid = 1"
					}
				}`
				&select=`{
					"TaggerTagResource": "*",
					"NameTag": "NameTag.tag, NameTag.alias",
					"Posts": "Posts.id, Posts.pagetitle, Posts.introtext",
...
<li class="tags-list__item"><a href="show-posts.html?tag=shopping" class="tags-list__item__link">шоппинг</a></li></ul>
  ...
  'elementCache' => 
  array (
    '[[$includes]]' => '<title>Вывод статей по тегу - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
