...
<html lang="ru">
  <head>
    <title>Новость 3 - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
      ...
      <div class="main-content">
        <div class="content-wrapper">
          <div class="content">
            ...
            <div class="article-image"><img src="assets/template/img/2.jpg" alt="Image поста"></div>
...
<p>Скидки доступны только между станциями, на которых останавливаются дальние поезда (ICE, IC, EC). Стыковочные переезды на региональных и пригородных поездах в этом варианте не разрешены (но они доступны при покупке обычных предварительных скидочных билетов Sparpreis от 29 евро, для коротких маршрутов - от 19 евро). Билет во всех случаях действует только на забронированный поезд, возврат и обмен возможны со штрафом в 17,5 евро и только минимум за день до даты поездки.</p>
			...
			<div class="article-pagination"><div class="article-pagination__block pagination-prev-left"><a href="/novosti/novost-2.html" class="article-pagination__link"><i class="icon icon-angle-double-left"></i>Предыдущая статья</a>
...
</div><div class="article-pagination__block pagination-prev-right"><a href="/novosti/novost-1.html" class="article-pagination__link">Сдедующая статья<i class="icon icon-angle-double-right"></i></a>
...
<li class="tags-list__item"><a href="show-posts.html?tag=shopping" class="tags-list__item__link">шоппинг</a></li></ul>
  ...
  'elementCache' => 
  array (
    '[[$includes]]' => '<title>Новость 3 - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
