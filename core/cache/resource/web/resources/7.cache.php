<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus ipsum nec gravida rutrum. Quisque placerat egestas augue, et hendrerit dui pharetra porta. Sed venenatis volutpat mi, in cursus nibh placerat nec. Quisque vel augue arcu. Integer a commodo mauris. Curabitur auctor convallis maximus. Vestibulum eleifend, nulla sit amet scelerisque commodo, nulla mi consectetur arcu, a mollis felis arcu ut libero. Morbi ac dolor id risus pretium ornare et in libero. Proin rhoncus euismod auctor. Nulla convallis quam nec risus bibendum convallis. Nullam commodo eu tellus a malesuada. Quisque auctor metus a arcu pharetra commodo. Maecenas viverra, urna non feugiat finibus, diam tortor mattis nisl, eget sollicitudin mauris ipsum dignissim sem.</p>
<p>Cras faucibus, eros sit amet finibus suscipit, dui turpis fringilla libero, sit amet accumsan ligula enim sed magna. Vivamus imperdiet felis nec consequat volutpat. Suspendisse pharetra congue dolor ac venenatis. Vivamus a mattis neque. Donec at placerat ex. Fusce eleifend purus enim, id scelerisque elit maximus at. Ut tempor, risus sagittis feugiat placerat, nunc mi tincidunt ante, id aliquam libero ex ut dolor.</p>
<p>Maecenas pellentesque nulla justo, vitae vestibulum tellus porta et. Mauris nulla lorem, sollicitudin a leo in, scelerisque auctor arcu. Aliquam ut mi elit. Quisque eget suscipit enim, sed dictum risus. Praesent nec libero feugiat, pellentesque libero at, dapibus nunc. Cras pulvinar posuere quam id sodales. Mauris ultrices massa tellus, eu bibendum enim iaculis sit amet. Curabitur ac magna diam. Ut tempor venenatis ligula molestie laoreet.</p>
<p>Aenean vitae augue tempor, maximus risus sed, iaculis metus. Vestibulum volutpat eleifend sapien, in pellentesque velit egestas facilisis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Etiam tincidunt magna dignissim, vulputate nisi ut, condimentum urna. Vivamus quam lorem, ornare sit amet sollicitudin nec, accumsan in turpis. Ut mattis scelerisque lectus at efficitur. Vestibulum egestas vel dolor nec faucibus. Nulla facilisi. Quisque dolor risus, dignissim quis diam viverra, lobortis aliquam sapien. Aliquam sed tortor ante. Nulla risus nunc, fringilla quis nisi vitae, scelerisque sagittis magna. Vivamus convallis orci neque, sed lobortis elit mattis eu. Mauris magna ipsum, faucibus sed interdum id, fringilla et neque. Praesent eu lobortis nunc. Donec fringilla mattis consequat.</p>
<p>Duis magna libero, varius sit amet placerat aliquam, ultricies id nunc. Nulla orci mi, malesuada eu bibendum sit amet, molestie sit amet ante. Vivamus at urna quam. Pellentesque finibus dapibus neque, at placerat augue vulputate in. Nullam ultrices, sapien in pharetra vestibulum, eros magna mollis velit, at elementum magna urna sit amet purus. Vestibulum sed elit lorem. Nunc sit amet est maximus, auctor diam a, congue ante. Duis condimentum tincidunt convallis. Praesent blandit tempus tortor in tincidunt. Integer aliquet sapien urna, ut molestie turpis laoreet quis.</p>',
    'richtext' => 1,
    'template' => 5,
    'menuindex' => 3,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1481566881,
    'editedby' => 1,
    'editedon' => 1481748730,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1481566860,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="ru">
  <head>
    <title>О сервисе - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
    ...
    <div class="wrapper">
        ...
        <div class="top-header">
          <div class="top-header__wrap">
            ...
            <nav class="main-navigation">
			  ...
			  <a href="poleznaya-informacziya.html" class="nav-list__nav-item__nav-link" >Полезная информация</a></li><li class="nav-list__nav-item">
			  <a href="poslednie-akczii/" class="nav-list__nav-item__nav-link" >Последние акции</a></li><li class="nav-list__nav-item" class="active">
      ...
      <div class="main-content">
        <div class="content-wrapper">
          <div class="content">
            <h2 class="title-page">О сервисе</h2>
...
<li class="tags-list__item"><a href="show-posts.html?tag=shopping" class="tags-list__item__link">шоппинг</a></li></ul>
        ...
        <div class="content-footer">
          <div class="bottom-menu">
            <ul class="b-menu__list"><li class="b-menu__list__item" class="first">
			  ...
			  <a href="poleznaya-informacziya.html" class="b-menu__list__item__link" >Полезная информация</a></li><li class="b-menu__list__item">
			  <a href="poslednie-akczii/" class="b-menu__list__item__link" >Последние акции</a></li><li class="b-menu__list__item" class="active">
  ...
  'elementCache' => 
  array (
    '[[$includes]]' => '<title>О сервисе - туристик</title>
	<base href="[[!++site_url]]" />
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
